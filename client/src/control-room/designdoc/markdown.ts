 ...
 */
import { readMention, type Mention } from "../../../../shared/mentions";
 ...
 *
 * The grammar moved to `shared/mentions.ts` when the server had to read it too; that file's header
 * says why. Re-exported here, unchanged, because this is where the rest of the inline markup lives
 * and every existing importer names this module.
 */
export type { Mention, MentionKind, MentionRun } from "../../../../shared/mentions";
export { mentionLabel, mentionMarkdown, parseMentions } from "../../../../shared/mentions";
